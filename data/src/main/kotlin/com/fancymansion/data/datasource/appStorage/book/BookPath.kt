...
class BookPath {
    companion object {
        ...
        fun pagePath(bookRef: BookRef, pageName: String) = pagesPath(bookRef).joinPath(pageJson(pageName))
...
fun File.pageFile(bookRef: BookRef, pageName: String) = File(this,
    BookPath.pagePath(bookRef, pageName)
)

...
interface BookStorageSource {
    ...
    fun getCacheZipFile(userId: String, publishedId: String): File
    suspend fun unzipBookArchiveToUserDir(zipFile: File, userId: String, mode: ReadMode, publishedId: String): File
}